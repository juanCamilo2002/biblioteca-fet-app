...
export const deleteAuthor = async (accessToken, id, notification) => {
    const api = customAxiosInstance(accessToken);
    try {
        const response = await api.delete("/autor/eliminar/" + id);
        notification.success("Autor eliminado correctamente")
        return response.data;
...
export const createAuthor = async (accessToken, data, notification) => {
    const api = customAxiosInstance(accessToken);
    try {
        const response = await api.post("/autor/agregar", data);
        notification.success("Autor creado correctamente")
        return response.data;
...
export const updateAuthor = async (accessToken, id, data, notification) => {
    const api = customAxiosInstance(accessToken);
    try {
        const response = await api.put("/autor/actualizar/" + id, data);
        notification.success("Autor actualizado correctamente")
        return response.data;
...
export const getReport = async (accessToken, notification) =>{
    ...
    try{
        const res = await api.get("/reports/infoReservas", {
...
export const getReportData = async (accessToken) =>{
    const api = customAxiosInstance(accessToken);
    try {
        const response = await api.get("/reports/DataReservas");
        return response;
    } catch (error) {
        console.error('error fetching data:', error);
        throw error
